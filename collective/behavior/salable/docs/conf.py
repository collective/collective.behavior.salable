...
project = u'collective.behavior.salable'
...
htmlhelp_basename = 'collective.behavior.salabledoc'
...
latex_documents = [
  ('index', 'collective.behavior.salable.tex', u'collective.behavior.salable Documentation',
...
man_pages = [
    (
        'index',
        'todo',
        u'collective.behavior.salable Documentation',
        [u'Taito Horiuchi'],
        1)]
